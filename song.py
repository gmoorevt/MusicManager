...
class Song(object):
    ...
    def compare(self,other):
        if self.songhash == other.songhash:
            return True
        else: return False
    ...
    def gethash(self):
        md5 = hashlib.md5("%s_%s_%s_%s" % (self.getArtist(), self.getAlbum(), self.getTitle(),self.bitrate))
    ...
    def print_tags(self):
        ...
        print 'Song Hash: %s' % self.gethash()
